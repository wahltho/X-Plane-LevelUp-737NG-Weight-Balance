...
- `737_60NG.acf`, `737_70NG.acf`, `737_80NG.acf`, `737_90NG.acf` and `737_9ENG.acf` matching
  `levelup600-wb-v1`, `levelup700-wb-v1`, `levelup800-wb-v2`, `levelup900-wb-v2` and
...
4. Extract every file from
   `LevelUp-737NG-Weight-Balance-v0.4.0.zip` directly into that folder. Do not
...
- package payload `v0.4.0` verified;
...
For an existing v0.2.0 through v0.3.1 installation, extract v0.4.0 over
