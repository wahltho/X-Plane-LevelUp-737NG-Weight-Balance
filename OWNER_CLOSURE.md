...
| ZFW CG | moment core | empty + planned/current stations | EFB ZFW | independent kg-m tests for all four | v0.3.2 not run |
| TOW CG | moment core | stations + fuel - 226.8 kg | EFB, `calc_to_cg`, FMC | all four plus handoff | v0.3.2 not run |
| LW CG | moment core | stations + destination fuel | EFB LW | all four | v0.3.2 not run |
...
| Installer lifecycle | common installer | stock .35 + four ACF contracts | five Tablet + two FMS blocks | LF/CRLF, idempotence, uninstall | not runtime |
