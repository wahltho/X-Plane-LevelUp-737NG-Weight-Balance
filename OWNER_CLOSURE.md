...
| ZFW CG | moment core | empty + planned/current stations | EFB ZFW | independent kg-m tests for all four | v0.3.1 not run |
| TOW CG | moment core | stations + fuel - 226.8 kg | EFB, `calc_to_cg`, FMC | all four plus handoff | v0.3.1 not run |
| LW CG | moment core | stations + destination fuel | EFB LW | all four | v0.3.1 not run |
...
| v0.1.4-v0.3.0 migration | common installer | legacy/current five blocks and backup | v0.3.1 contract | migration/idempotence harness | not runtime |
