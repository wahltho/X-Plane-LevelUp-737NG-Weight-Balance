...
EXPECTED = {
    ...
    "737_90NG.acf": {
        "variant": 1, "version": "levelup900-wb-v1",
        "reference_hash": "b736f745bf0f170e598ad896a8e055533107742478624e32239975194895d071",
        "overlay_hash": "2ac3fa0c5cc6c5002675712989f3a0ef4c9fdb9cf7c62e54c7819129a295e5cc",
        "mass": (94580, 64.650001526, 63.380001068, 67.129997253, 14.993530273, 174700, 46062.008),
        "names": ("Cargo1", "Cargo2", "Zone 1", "Zone 2", "Zone 3", "Zone 4", "Zone 5", "Galley F", "Galley A"),
        "arms": (43, 97, 35, 48.5, 66, 79, 92, 15, 108),
        "maxima": (7848, 10690, 10000, 10000, 10000, 10000, 10000, 3000, 3000),
        "roles": (1, 1, 0, 0, 0, 0, 0, 1, 1),
        "tank_empty": (70, 62, 70), "tank_full": (70, 62, 70),
    },
    "737_9ENG.acf": {
        "variant": 4, "version": "levelup900er-wb-v1",
        "reference_hash": "67256a2181435da50b0f31f2c0ebbf81732e530c7b3809de05967abf0930eec6",
        "overlay_hash": "06f5357b46ad6fa242464e11c64b988ec4a31cb5da0c7aaaa9d37af2d61c383e",
        ...
        "roles": (1, 1, 0, 0, 0, 0, 0, 1, 1),
        "tank_empty": (70, 62, 70), "tank_full": (69, 62, 69),
    },
}
